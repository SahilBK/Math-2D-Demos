...
class mainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        #Gram-Schmidt
        self.Displaygramu1vectorbox = []
        self.Displaygramu1vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox0_4'))
        self.Displaygramu1vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox1_4'))
        self.Displaygramu1vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox2_4'))

        self.Displaygramu2vectorbox = []
        self.Displaygramu2vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox0_3'))
        self.Displaygramu2vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox1_3'))
        self.Displaygramu2vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox2_3'))

        self.Displaygramu3vectorbox = []
        self.Displaygramu3vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox0_5'))
        self.Displaygramu3vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox1_5'))
        self.Displaygramu3vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox2_5'))

        self.Calculategrambutton = self.findChild(QtWidgets.QPushButton, 'Calculategrambutton')
        self.Calculategrambutton.clicked.connect(self.Calculategrambuttonclicked)

        self.Displaygramv1vectorbox = []
        self.Displaygramv1vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox0_7'))
        self.Displaygramv1vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox1_7'))
        self.Displaygramv1vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox2_7'))

        self.Displaygramv2vectorbox = []
        self.Displaygramv2vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox0_8'))
        self.Displaygramv2vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox1_8'))
        self.Displaygramv2vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox2_8'))

        self.Displaygramv3vectorbox = []
        self.Displaygramv3vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox0_6'))
        self.Displaygramv3vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox1_6'))
        self.Displaygramv3vectorbox.append(self.findChild(QtWidgets.QDoubleSpinBox, 'Vectorbdisplaybox2_6'))

        self.Animategrambutton = self.findChild(QtWidgets.QPushButton, 'Animategrambutton')
        self.Animategrambutton.clicked.connect(self.Animategrambuttonclicked)
        self.Animategrambutton.setDisabled(True)
    ...
    def Vectorset(self, vector, dispbox):
        vector[0] = dispbox[0].value()
        vector[1] = dispbox[1].value()
        vector[2] = dispbox[2].value()

    def Vectordisplayset(self, vector, dispbox):
        dispbox[0].setValue(vector[0])
        dispbox[1].setValue(vector[1])
        dispbox[2].setValue(vector[2])
    ...
    def Reflectioncalculate(self):
        ...
        return np.identity(3) - 2 * reflectvector.dot(reflectvector.T)
    ...
    def Calculategrambuttonclicked(self):
        self.Vectorset(self.u1vector, self.Displaygramu1vectorbox)
        self.Vectorset(self.u2vector, self.Displaygramu2vectorbox)
        self.Vectorset(self.u3vector, self.Displaygramu3vectorbox)

        self.v1vector = self.u1vector
        self.v2vector = self.u2vector - (self.u2vector.T.dot(self.v1vector) / self.v1vector.T.dot(self.v1vector)) * self.v1vector
        self.v3vector = self.u3vector - (self.u3vector.T.dot(self.v1vector) / self.v1vector.T.dot(self.v1vector)) * self.v1vector \
            - (self.u3vector.T.dot(self.v2vector) / self.v2vector.T.dot(self.v2vector)) * self.v2vector

        self.Vectordisplayset(self.v1vector, self.Displaygramv1vectorbox)
        self.Vectordisplayset(self.v2vector, self.Displaygramv2vectorbox)
        self.Vectordisplayset(self.v3vector, self.Displaygramv3vectorbox)

        self.Animategrambutton.setDisabled(False)

    def Animategrambuttonclicked(self):
        self.openGLWidget.u1vector = self.u1vector
        self.openGLWidget.u2vector = self.u2vector
        self.openGLWidget.u3vector = self.u3vector
        self.openGLWidget.v1vector = self.v1vector
        self.openGLWidget.v2vector = self.v2vector
        self.openGLWidget.v3vector = self.v3vector

        self.openGLWidget.pauseflag = False
        self.openGLWidget.framecount = 0
        self.openGLWidget.displayflag = 4
        self.openGLWidget.updateflag = 1
